...
import com.jqh.forum.recruit.service.EnterpriseService;
...
public class EnterpriseController {
    ...
    public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        PageResult<Enterprise> search = enterpriseService.findSearch(searchMap, page, size);
    ...
    public Result getHotEnterpriseList(){
        List<Enterprise> enterprises =enterpriseService.selectByIsHot("1");
